...
<style>
    .layuimini-container h4 {font-size:18px;font-family:"Microsoft YaHei","Simsun",Arial;font-weight:normal;line-height:1;padding:0;margin:0;}
    .layuimini-container .icons li {margin:5px 0;text-align:center;height:120px;cursor:pointer;}
    .layuimini-container .icons li i {display:block;font-size:35px;margin:10px 0;line-height:60px;height:60px;}
    .layuimini-container .icons li:hover {background:#2f4056;border-radius:5px;color:#fff;}
    .layuimini-container .icons li:hover i {font-size:50px;}
    .layuimini-container .section {padding:20px;}
    .layuimini-container .section h4 span {color:#0084e9;}
    .layuimini-container .fa {font-size:25px !important;}
    .layuimini-container .fa:hover {font-size:50px !important;}
</style>
