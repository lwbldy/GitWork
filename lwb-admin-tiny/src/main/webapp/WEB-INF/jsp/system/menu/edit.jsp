...
<div style="padding: 20px">
    ...
    <form class="layui-form layui-form-pane" action="" id="ajaxForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input class="layui-input" autocomplete="off" type="text" id="icon" name="icon" >
            </div>
    ...
    layui.use(['form','layer','tree'], function() {
        ...
        $(document).ready(function(){
            $.get("<%=request.getContextPath()%>/sysmenu/findTreeMenu", function (data) {
                ...
                //重写加载菜单信息
                $.get("<%=request.getContextPath()%>/sysmenu/info/${id}",
                    function (data) {
                        //表单自动填充
                        $("#ajaxForm").autofill(data.sysMenu);

                        console.log(JSON.stringify(data))

                        if(data.sysMenu.parentId == 0){
                            $("#parentName").val("一级菜单");
                        }
        ...
        form.on('submit(save)', function(data){
            ...
            $.ajax({
                type : 'post',
                url : "<%=request.getContextPath()%>/sysmenu/edit",
                data:data.field,
                dataType: "json",
