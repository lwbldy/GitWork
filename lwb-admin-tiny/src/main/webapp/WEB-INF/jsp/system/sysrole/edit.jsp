        ...
        layui.use(['form','layer','tree'], function(){
            ...
            $(function(){
                ...
                $.get("<%=request.getContextPath()%>/sysmenu/fundAll", function(r){
                    ...
                    // 在展开后进行调用
                    $.get("<%=request.getContextPath()%>/sysrole/info/${id}",
                        function (data) {
                            //表单自动填充
                            $("#ajaxForm").autofill(data.sysRole);
                            //调用选中
                            getRole(data.roleList);
                            layer.close(index);
                        },
                        "json"
                    );
            ...
            form.on('submit(save)', function(data){
                ...
                $("#ajaxForm").ajaxSubmit({
                    type : 'post',
                    url : "<%=request.getContextPath()%>/sysrole/edit",
                    dataType:'json',
